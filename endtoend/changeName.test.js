...
describe('Puppeteer tests', () => {
  ...
  it('should change name without error', async () => {
    ...
    await page.waitForSelector('[class$="profileAndCreateStyles_inputName__2H0Zf"]', { timeout: 1000 })
    ...
    await page.waitForSelector('[src$="/static/media/tick.9bf6c7db.png"]', { timeout: 200 })
